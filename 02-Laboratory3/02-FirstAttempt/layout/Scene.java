...
import drawingTool.DataPlotter;
...
public class Scene {
    ...
    public void setSensorData(SensorData data) {
        ...
        System.out.println("Scene.setSensorData called, data is " + (data == null ? "null" : "not null, size=" + data.getSize()));
        function.setSensorData(data);
        autoFitViewport();
        System.out.println("autoFitViewport completed");
    }
    ...
    public void rescaleToSelectedData() {
        ...
        // If no columns selected, don't re-scale
