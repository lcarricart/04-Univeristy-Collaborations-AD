...
public class CheckBoxPanel extends JPanel{
    ...
    public CheckBoxPanel() {
    	...
    	styleCheckBox(showZerosCheckBox);
    	styleCheckBox(showExtremasCheckBox);
    	styleCheckBox(showHistogramCheckBox);
    ...
    private void styleCheckBox(JCheckBox checkBox) {
        checkBox.setFont(ModernTheme.LABEL_FONT);
        checkBox.setForeground(ModernTheme.TEXT_PRIMARY);
        checkBox.setBackground(ModernTheme.PANEL_DARK);
